...
@Controller     //필기 빈으로 등록
@RequestMapping("/order/*")         //필기 우선권이 있다.
/* 필기.
...
public class ClassMappingTestController {
    ...
    /* 여러 개의 패턴 매핑 */
    @RequestMapping(value = {"/modify","/delete"},method = RequestMethod.POST)  // 필기 두개 이상 호출할떄는 {} 안에 입력해준다
